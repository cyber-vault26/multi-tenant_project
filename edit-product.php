...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_stmt = $pdo->prepare("UPDATE products SET name = ?, sku = ?, purchase_price = ?, sale_price = ?, stock_quantity = ? WHERE id = ? AND tenant_id = ?");
    $update_stmt->execute([$name, $sku, $p_price, $s_price, $qty, $product_id, $tenant_id]);
